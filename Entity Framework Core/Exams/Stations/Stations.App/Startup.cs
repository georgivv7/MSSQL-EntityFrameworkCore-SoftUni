...
namespace Stations.App
{
	public class Startup
	{
		...
		private static void ImportEntities(StationsDbContext context, string baseDir = @"D:\C#-SoftUni\C# DATABASES ADVANCED  - Entity Framework\ExamPreps\Stations\Stations.App\files\")
		{
			const string exportDir = @"D:\C#-SoftUni\C# DATABASES ADVANCED  - Entity Framework\ExamPreps\Stations\Stations.App\files\ImportResults\";
		...
		{
			const string exportDir = @"D:\C#-SoftUni\C# DATABASES ADVANCED  - Entity Framework\ExamPreps\Stations\Stations.App\files\ExportResults\";
		...
		private static void ResetDatabase(StationsDbContext context, bool shoudDeleteDatabase = false)
		{
            if (shoudDeleteDatabase)
            {
				context.Database.EnsureDeleted();
				context.Database.EnsureCreated();
			}			
